...
async def analyze_with_gemini(prompt: str) -> str:
    # Define the JSON schema you want back, now including codeChanges
    response_schema: Schema = {
        "type": Type.OBJECT,
        "properties": {
            "route": {"type": Type.STRING},
                ...
                "properties": {
                    metric: {
                        ...
                        "items": {
                            ...
                            "required": ["file", "startLine", "endLine", "oldCode", "newCode", "explanation"],
                        },
                    }
                    for metric in ("FCP", "LCP", "CLS", "TBT")
                },
        ...
        "required": ["route", "performanceData", "codeChanges"],
    }
